DECLARE @DistrictID varchar(10) = '2498'
------------------ NAVIGATOR TABLES ------------------
------------------ NJSLS LINKIT BMS ------------------
...
create table #bm (School varchar(100), Grade varchar(5), Subject varchar(50), [Latest Results] date,
...
create table #classbm (School varchar(100), Grade varchar(5), Subject varchar(50), Teacher varchar(102), Class varchar(200),
[23-24 Form A] int, [23-24 Form B] int, [23-24 Form C] int)
