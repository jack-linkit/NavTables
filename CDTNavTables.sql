...
set @testName = 'CDT' --Name in test name
set @categoryName = 'CDT' --Name of Category
set @beg = 'Fall'
set @mid = 'Winter'
set @end = 'Spring'

declare @begMonth VARCHAR(50) = '09 Gr'
declare @begAltMonth VARCHAR(50) = '11 Gr'
declare @midMonth VARCHAR(50) = '0[12] Gr'
declare @midAltMonth VARCHAR(50) = '12 Gr'
declare @endMonth VARCHAR(50) = '0[3456] Gr'
...
sum(case when vt.Name like ''%22-%23%'' and vt.Name like + ''%'' + ''' + @testName + ''' + ''%'' and (vt.Name like  ''%'' + ''' + @beg + ''' +''%'' or vt.Name like ''%'' + ''' + @begMonth + ''' + ''%'' or vt.Name like ''%'' + ''' + @begAltMonth + ''' + ''%'' ) then 1 else 0 end) as [22-23 '+ @beg +'],
sum(case when vt.Name like ''%22-%23%'' and vt.Name like + ''%'' + ''' + @testName + ''' + ''%'' and (vt.Name like  ''%'' + ''' + @mid + ''' +''%'' or vt.Name like ''%'' + ''' + @midMonth + ''' + ''%'' or vt.Name like ''%'' + ''' + @midAltMonth + ''' + ''%'' ) then 1 else 0 end) as [22-23 '+ @mid +'],
sum(case when vt.Name like ''%22-%23%'' and vt.Name like + ''%'' + ''' + @testName + ''' + ''%'' and (vt.Name like  ''%'' + ''' + @end + ''' +''%'' or vt.Name like ''%'' + ''' + @endMonth + ''' + ''%'') then 1 else 0 end) as [22-23 '+ @end +'],
sum(case when vt.Name like ''%23-%24%'' and vt.Name like + ''%'' + ''' + @testName + ''' + ''%'' and (vt.Name like  ''%'' + ''' + @beg + ''' +''%'' or vt.Name like ''%'' + ''' + @begMonth + ''' + ''%'' or vt.Name like ''%'' + ''' + @begAltMonth + ''' + ''%'' ) then 1 else 0 end) as [23-24 '+ @beg +'],
sum(case when vt.Name like ''%23-%24%'' and vt.Name like + ''%'' + ''' + @testName + ''' + ''%'' and (vt.Name like  ''%'' + ''' + @mid + ''' +''%'' or vt.Name like ''%'' + ''' + @midMonth + ''' + ''%'' or vt.Name like ''%'' + ''' + @midAltMonth + ''' + ''%'' ) then 1 else 0 end) as [23-24 '+ @mid +'],
sum(case when vt.Name like ''%23-%24%'' and vt.Name like + ''%'' + ''' + @testName + ''' + ''%'' and (vt.Name like  ''%'' + ''' + @end + ''' +''%'' or vt.Name like ''%'' + ''' + @endMonth + ''' + ''%'') then 1 else 0 end) as [23-24 '+ @end +']
